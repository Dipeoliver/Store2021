...
namespace Store2021
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<Store2021Context>(options =>
                    options.UseMySql(Configuration.GetConnectionString("Store2021Context"), builder =>
                        builder.MigrationsAssembly("Store2021")));
